<?php
namespace BoilerAppDisplayTest\Service;
class TemplatingConfigurationTest extends \PHPUnit_Framework_TestCase{
	...
	public function setUp(){
		$this->templateConfiguration = \BoilerAppDisplayTest\Bootstrap::getServiceManager()->get('TemplatingService')->getConfiguration();
	}
