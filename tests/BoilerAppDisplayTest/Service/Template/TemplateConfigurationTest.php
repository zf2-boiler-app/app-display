<?php
namespace BoilerAppDisplayTest\Service\Template;
class TemplateConfigurationTest extends \PHPUnit_Framework_TestCase{
	...
	public function setUp(){
		$this->templateConfiguration = \BoilerAppDisplayTest\Bootstrap::getServiceManager()->get('TemplatingService')->getConfiguration()->getTemplateMapForModule()->getConfiguration();
	}
